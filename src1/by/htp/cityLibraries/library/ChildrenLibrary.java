...
public class ChildrenLibrary extends Library implements Librarian, Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = -6696233950592601026L;
	...
	public String toString() {
		return "Library [nameLibrary=" + getNameLibrary() + ", adressLibrary=" + getAdressLibrary() + ", printEdition="+printEdition+"]";
	}	
